...
# def save_cve_cwe_data(data_tuples, json_filename='cve_cwe_data.json', text_filename='cve_cwe_data.txt'):
#     """
#     Save CVE-CWE tuples to both JSON and text files.
    
#     Args:
#         data_tuples: List of tuples in format ('CVE-ID', 'CWE-ID')
#         json_filename: Output JSON filename
#         text_filename: Output text filename
#     """
